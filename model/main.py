...
for filme in filmes_recomendados_sorted:
    print(f"Título: {filme['titulo']}, Gêneros: {', '.join(filme['generos'])}, Nota: {filme['nota']}")
...
# Exemplo de uso
filmes_com_imagens = obter_imagens_filmes_recomendados(filmes_recomendados_sorted, filmes)

# Exibir as imagens e títulos dos filmes recomendados
print("\n URLs dos posters:")

for filme in filmes_com_imagens:
    print(f"\nTítulo: {filme['titulo']}, Imagem URL: {filme['imagem']}")